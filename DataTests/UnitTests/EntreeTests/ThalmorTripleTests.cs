...
{
    /// <summary>
    /// Tests the ThalmorTriple class in the Data library
    /// </summary>
    public class ThalmorTripleTests
    {
        ...
        [Fact]
        public void ChangingBaconInvokesPropertyChanged()
        {
            ThalmorTriple tt = new ThalmorTriple();
        ...
        [Fact]
        public void ChangingEggInvokesPropertyChanged()
        {
            ThalmorTriple tt = new ThalmorTriple();
        ...
        {
            ThalmorTriple tt = new ThalmorTriple();
            tt.Bun = includeBun; tt.Ketchup = includeKetchup; tt.Mustard = includeMustard; tt.Pickle = includePickle; tt.Cheese = includeCheese;
            tt.Tomato = includeTomato; tt.Lettuce = includeLettuce; tt.Mayo = includeMayo; tt.Bacon = includeBacon; tt.Egg = includeEgg;
            ...
            if (includeBun && includeKetchup && includeMustard && includePickle && includeCheese && includeTomato && includeLettuce && includeMayo
                && includeBacon && includeEgg) { Assert.Empty(tt.SpecialInstructions); }
        }
